//
//  ScienceSectionViewController.swift
//  News App
//
...
class ScienceSectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider, ToastDelegate {
    ...
    func setNewsCardArray() {
        ...
        self.newsCardManager.fetchSectionNewsCardData("science") {value in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ScienceCardCell", for: indexPath) as! NewsCardCell
