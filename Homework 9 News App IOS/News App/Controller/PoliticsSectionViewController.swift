//
//  PoliticsSectionViewController.swift
//  News App
//
...
class PoliticsSectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider, ToastDelegate {
    ...
    func setNewsCardArray() {
        ...
        self.newsCardManager.fetchSectionNewsCardData("politics") {value in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "PoliticsCardCell", for: indexPath) as! NewsCardCell
