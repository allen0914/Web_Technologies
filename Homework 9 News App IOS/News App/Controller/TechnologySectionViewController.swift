//
//  TechnologySectionViewController.swift
//  News App
//
...
class TechnologySectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider, ToastDelegate {
    ...
    func setNewsCardArray() {
        ...
        self.newsCardManager.fetchSectionNewsCardData("technology") {value in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "TechnologyCardCell", for: indexPath) as! NewsCardCell
