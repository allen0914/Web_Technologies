//
//  BusinessSectionViewController.swift
//  News App
//
...
class BusinessSectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, IndicatorInfoProvider, ToastDelegate {
    ...
    func setNewsCardArray() {
        ...
        self.newsCardManager.fetchSectionNewsCardData("business") {value in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "WorldCardCell", for: indexPath) as! NewsCardCell
